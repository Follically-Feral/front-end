...
@Component({
    ...
    templateUrl: 'app/components/management/registration/registration.component.html',
    styleUrls: ['app/components/management/registration/registration.component.css']
})
