System.register(['angular2/core', 'angular2/router', "../../../../../common/auth-check", "../../../../../directives/dynamic-form/normalForm/dynamic-form.directive", "../../../../../services/form-data.service", "../../../../../directives/messages/messages.directive", "../../../../../models/group", "../../../../../services/group.service", "../../../../../directives/dynamic-form/modalForm/dynamic-modal-form.directive", "../../../../../services/user.service"], function(exports_1, context_1) {
    ...
    var core_1, router_1, auth_check_1, dynamic_form_directive_1, form_data_service_1, messages_directive_1, group_1, group_service_1, dynamic_modal_form_directive_1, user_service_1;
    ...
    return {
        ...
        execute: function() {
            GroupDetailComponent = (function () {
                function GroupDetailComponent(_groupService, _routeParams, _router, _formDataService, _userService) {
                    var _this = this;
                ...
                GroupDetailComponent = __decorate([
                    core_1.Component({
                        ...
                        templateUrl: 'app/components/management/userManagement/groups/groupDetail/group-detail.component.html',
                        styleUrls: ['app/components/management/userManagement/groups/groupDetail/group-detail.component.css'],
                    ...
                    __metadata('design:paramtypes', [group_service_1.GroupService, router_1.RouteParams, router_1.Router, form_data_service_1.FormDataService, user_service_1.UserService])
