...
@Component({
    selector: 'groups',
    templateUrl: 'app/components/management/userManagement/groups/groups.component.html',
    styleUrls: ['app/components/management/userManagement/groups/groups.component.css'],
