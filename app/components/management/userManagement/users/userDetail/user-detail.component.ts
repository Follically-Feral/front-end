...
@Component({
    ...
    templateUrl: 'app/components/management/userManagement/users/userDetail/user-detail.component.html',
    styleUrls: ['app/components/management/userManagement/users/userDetail/user-detail.component.css'],
